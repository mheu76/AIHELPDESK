...
# SQLite and DEBUG mode both use NullPool; only production non-SQLite gets QueuePool
if not settings.DATABASE_URL.startswith("sqlite") and not settings.DEBUG:
